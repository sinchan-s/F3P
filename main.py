...
sns.violinplot(data=result_df, x='Weft Tensile', y='Coverage group', linewidth=3).set(title='Weft Tensile range')
col1.pyplot(fig3)

fig4 = plt.figure(figsize=(8, 3))
sns.violinplot(data=result_df, x='Warp Tensile', y='Coverage group', linewidth=3).set(title='Warp Tensile range')
col2.pyplot(fig4)
